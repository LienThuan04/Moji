...
type signupFormSchemaType = z.infer<typeof signupFormSchema>;// lấy kiểu dữ liệu từ schema để suy ra kiểu dữ liệu của form
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-6" onSubmit={handleSubmit(onSubmit)}>
            <FieldGroup>
              ...
              <Field>
                <Field className="grid grid-cols-2 gap-4">
                  <Field>
                    ...
                    <Input id="first-name" type="text"  placeholder="Your First Name" {...register("firstName")} />
                    {errors.firstName && (
                  ...
                  <Field>
                    ...
                    <Input id="last-name" type="text"  placeholder="Your Last Name" {...register("lastName")} />
                    {errors.lastName && (
              ...
              <Field>
                ...
                />
                {errors.username && (
                  <p className="text-sm text-red-500">{String(errors.username?.message)}</p>
                )}
              </Field>
              <Field>
