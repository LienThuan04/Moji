...
type signinFormSchemaType = z.infer<typeof signinFormSchema>;// lấy kiểu dữ liệu từ schema để suy ra kiểu dữ liệu của form
...
export function SigninForm({
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<signinFormSchemaType>({
